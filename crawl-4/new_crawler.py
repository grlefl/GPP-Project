...
file_name = os.path.join(output_file); file_exists = os.path.isfile(file_name)  # make sure file exists
...
with open(file_name, mode="a", newline="", encoding="utf-8") as file:
    ...
    with open(input_file, newline="", encoding="utf-8") as f:  # UPDATE THIS PATH
        ...
        for row in reader:
            ...
            gpp_ping = None; gpp_string = None; section_list = None; nat_gpc_signal = False; natv1_gpc_signal = False; error = None  # initialize uncertain variables
            ...
            try:
                ...
                try:
                    ...
                    if 'usnat' in gpp_ping['data']['parsedSections'].keys():
                        nat_gpc_signal = gpp_ping['data']['parsedSections']['usnat']['Gpc']
                    if 'usnatv1' in gpp_ping['data']['parsedSections'].keys():
                        natv1_gpc_signal = gpp_ping['data']['parsedSections']['usnatv1']['Gpc']
            ...
            writer.writerow([rank, url, network_ip, state, gpp_string, section_list, (nat_gpc_signal or natv1_gpc_signal), gpp_ping, error])
